...
function innocode_block_social_share_socials() : array {
	return apply_filters( 'innocode-block-social-share-socials', [
		'facebook' => [
			'label' => esc_html__( 'Share on Facebook', 'innocode-blocks' ),
		...
		'twitter'  => [
			'label' => esc_html__( 'Share on Twitter', 'innocode-blocks' ),
		...
		'linkedin' => [
			'label' => esc_html__( 'Share on LinkedIn', 'innocode-blocks' ),
		...
		'email'    => [
			'label' => esc_html__( 'Share via email', 'innocode-blocks' ),
